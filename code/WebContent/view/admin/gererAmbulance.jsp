...
<head>
    ...
    <title>Gérer les Ambulances</title>
...
Admin adm = adm1.get(0);
    List<Ambulance> ambulances = dao.AmbulanceDao.getAll();
%>
   <div class="sidebar">
